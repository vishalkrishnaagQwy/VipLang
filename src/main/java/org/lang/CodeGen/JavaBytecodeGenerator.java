...
public class JavaBytecodeGenerator implements AST, Opcodes {
    ...
    public void visitMethodDefNode(MethodDefNode methodDefNode) {
        String descriptor = "()V";
        MethodVisitor mv = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, methodDefNode.getFunctionName(), descriptor, null, null);
        mv.visitCode();
    ...
    public void visitMethodDefNode(MethodDefNode methodDefNode,MethodVisitor methodVisitor) {
        String descriptor = "()V";
        if(methodDefNode.getFunctionName().equals("main"))
        {
...
// End of loop
    ...
    public void visitStringLiteralNode(StringLiteralNode stringLiteralNode,MethodVisitor methodVisitor) {
        methodVisitor.visitLdcInsn(stringLiteralNode.getValue());
    }
    ...
    public void visitNumberNode(NumberNode numberNode, MethodVisitor methodVisitor) {
        switch (numberNode.getType())
        {
            case INT -> {
                methodVisitor.visitLdcInsn(Integer.parseInt(numberNode.getValue()));
                methodVisitor.visitVarInsn(Opcodes.ISTORE, 1);
            }
            case FLOAT -> {
                methodVisitor.visitLdcInsn(Float.parseFloat(numberNode.getValue()));
                methodVisitor.visitVarInsn(Opcodes.FSTORE, 1);
            }
            case DOUBLE -> {
                methodVisitor.visitLdcInsn(Double.parseDouble(numberNode.getValue()));
